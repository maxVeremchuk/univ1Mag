...
class Fertility_Decoder:
    def __init__(self, encoder,
                 fertility_attention, lenvalue_generator, gate_generator,
                 context_embeding, domain_embeding, slot_embeding):
        super(Fertility_Decoder, self).__init__()
        self.encoder = encoder
        self.lenvalue_generator = lenvalue_generator
    ...
    def forward(self, b):
        ...
        generated_lenvalue = self.lenvalue_generator(out_slots)
        generated_gates = self.gate_generator(out_slots)
        return out, generated_lenvalue, generated_gates
