...
class Pubkey(object):
    ...
    def verify(self, value=None, value_hash=None, s=None, r=None, signature=None):
        ...
        domain = context.ldata.curve_domain
        try:
            truncated = math.Field.truncate(value_hash)
    ...
    def _help_verify(self, value, s, r, domain=None):
        ...
        r1 = math.Field.mul(long(value), pointR.x.v)
        r1 = math.Field.truncate(r1)
        return r1 == r
...
class Priv(object):
    ...
    def sign(self, value=None, value_hash=None):
        ...
        truncated = math.Field.truncate(value_hash, domain.param_m)
        while True:
            try:
    ...
    def _help_sign(self, value, rand_e, domain):
        ...
        value = math.Field.truncate(value, domain.param_m)
        r = math.Field.mul(value, eG.x.v)
        r = math.Field.truncate(r)
        if r == 0:
